  ...
  const script = `
    (function () {
      window.ChatbotConfig = {
        flowId: "${flowId || ''}",
        userId: "${userId || ''}",
        baseUrl: "https://custom-gpt-backend-six.vercel.app",
        theme: {
